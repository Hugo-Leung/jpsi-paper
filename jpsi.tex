...
\begin{figure}
	\missingfigure{mass fit plot for $p+p$}
...
\begin{figure}
	\missingfigure{mass fit plot for $p+d$}
...
\todo{describe the $\sigma_{\psi'}/\sigma{J/\psi}$ ratio\\
...
\label{sec:CSR}
\begin{figure}
	\missingfigure{$pd/pp$ cross section ratio }
